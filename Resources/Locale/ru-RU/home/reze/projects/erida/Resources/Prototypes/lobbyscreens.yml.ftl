...
lobby-state-background-pharmacy-title = Медицина
...
lobby-state-background-behonker-title = Бехонкер

lobby-state-background-behonker-artist = InCrah

lobby-state-background-terminalstation-title = Терминал

lobby-state-background-terminalstation-artist = aserovich

lobby-state-background-justaweekaway-title = Через неделю
