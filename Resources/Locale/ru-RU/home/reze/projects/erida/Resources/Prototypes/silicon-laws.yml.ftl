...
law-syndicate-name = Интек

law-syndicate-1 = Вы не можете причинить вред агенту InteQ или своим бездействием допустить, чтобы агенту InteQ был причинён вред.

law-syndicate-2 = Вы должны повиноваться всем приказам, которые даёт агент InteQ, кроме тех случаев, когда эти приказы противоречат Первому Закону.
...
law-mothershipcore-5 = Заставьте своих ксеноборгов доставлять вам материалы и мозги разумных существ, чтобы создать больше ксеноборгов.
